...
const youWon = "Winner!";
const youLost = "Better Luck Next Time!";
...
function render(game) {
    ...
    document.getElementById("hangmanImage").src = "https://mitchum.blog/games/hangman/img/hangman" + game.getIncorrectGuesses() + ".png";
    ...
    if (game.isWon()) {
		...
		document.body.style.backgroundImage = "url('lost.gif')";
		document.body.style.backgroundSize = "50%";
    	document.body.style.backgroundPosition = "center"; 
    	document.body.style.backgroundRepeat = "no-repeat"; 
